...
batch_size = 128
emb_size = 32
train_dl = RectanglesDataLoader((32,32),(0,1),(4,28), batch_size, 1)
valid_dl = RectanglesDataLoader((32,32),(0,1),(4,28), batch_size, 1)
...
vq = VectorQuantize(dim = emb_size, codebook_size = 512, decay = 0.999, commitment_weight = 0.0, use_cosine_sim = True, threshold_ema_dead_code = 0.001)
vasf_model = vasf.Vasf(m1, m2, m3, vq).float()
loger = logger.Logger('experiments/easy15')
...
my_trainer.train(600000, 5000, 3)
